...
export const mdxComponents: MDXComponents = {
  ...
  h2: ({ children, id, ...props }) => (
    <h2
      id={id}
      className="mt-10 mb-4 text-2xl font-semibold tracking-tight text-foreground scroll-mt-20 group"
      {...props}
    >
  ...
  pre: ({ children, ...props }: any) => (
    <div className="group relative my-6">
      <pre
        className="overflow-x-auto rounded-xl border border-border bg-muted/50 p-4 text-sm leading-relaxed"
        {...props}
      >
        {children}
      </pre>
